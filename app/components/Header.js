...
const Header = () =>
{
    ...
    return(
        <div className='fixed md:text-sm text-xs top-0 z-50 w-[100%] flex items-center justify-between p-5 shadow-lg' style={{backgroundColor: 'var(--primary-color)'}}>
            ...
            {showDetails && 
            <Card className='fixed w-[90%] sm:w-96 top-20 sm:right-5 right-[5%] flex flex-col items-end gap-2 p-6 '>
