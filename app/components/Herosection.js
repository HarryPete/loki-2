...
const HeroSection = ({scrollIntoSection, section4}) =>
{
    ...
    return(
        <div className='h-[100vh] flex flex-col justify-center items-center relative text-white z-10'>
            ...
            <div className='z-10 flex flex-col mt-[10vh] items-center justify-between gap-8 px-[5vw]'>
                <h1 className='md:text-5xl sm:text-2xl text-xl font-semibold flex flex-col md:gap-3 gap-2 items-center'>
                    Ready to master <TypingAnimation className='md:text-7xl sm:text-5xl text-4xl  text-red-600 font-bold shadow-sm'>
                        Financial Crime </TypingAnimation> Detection & Prevention ?</h1>
