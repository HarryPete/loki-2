        ...
        <div className='mt-12 relative'>
            ...
            {/* <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink href={`/courses/${course.id}`}>{course.id}</BreadcrumbLink>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb> */}
            ...
            <Button onClick={handleClick} className='w-fit md:h-10 h-10 text-xs md:text-sm'>Join Now</Button>
            </div>
        </div>
